    ...
    <body>
                    ...
                    <ul class="user-menu">
                        <li class="dropdown pull-right">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="quantri.php?page_layout=thanhvien"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Thông tin thành viên</a></li>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=thanhvien">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=danhsachqc">
                    ...
                    <ul class="children collapse" id="sub-item-5">
                        <li>
                            <a class="" href="quantri.php?page_layout=themqc">
                                <svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Thêm mới
                            </a>
                        </li>
            ...
            if(isset($_GET["page_layout"])){
                switch ($_GET["page_layout"]) {
                    ...
                    case 'suadm':include_once './suadm.php';                
                        break;
                    case 'thanhvien':include_once './dsthanhvien.php';                
                        break;                        
                }
            }
            else{
