...
<div class="products">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 product-item text-center">
            <a href="index.php?page_layout=chitietsp&id_sp=<?php echo $row2['id_sp']; ?>"><img  height="144" src="quantri/anh/<?php echo $row2['anh_sp']; ?>"></a>
...
?>
<div class="products">
    <h2 class="h2-bar">Đổ Cổ Có Giá Trị Cao</h2>
    <div class="row">
        <?php
